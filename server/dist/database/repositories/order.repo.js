...
export const orderRepo = {
    ...
    findByUser: (userId) => db.prepare('SELECT o.*, p.name as product_name, p.uc_amount, c.code FROM orders o JOIN products p ON o.product_id = p.id LEFT JOIN codes c ON o.code_id = c.id WHERE o.user_id = ? ORDER BY o.created_at DESC').all(userId),
